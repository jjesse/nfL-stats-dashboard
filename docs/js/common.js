...
(function(window) {
    ...
    const NFLCommon = {
         ...
         * Note: This is a simple CSV parser that splits on commas. 
         * It does not handle quoted values containing commas.
         * The NFL stats CSV files generated by this project don't use quoted values.
         ...
         * Note: This uses Image() and only works reliably for image files (PNG, JPG, etc.)
